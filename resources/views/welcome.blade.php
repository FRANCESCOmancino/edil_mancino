<x-layout>
    <Header class="pb-lg-5 bgSecondary">
        <div data-aos="zoom-out"  data-aos-duration="1500" class="container-fluid bgHeader d-flex flex-column justify-content-center pb-lg-4 ">
    ...
    <section class="py-5 bgSecondary" id="section1">
        <div class="container-fluid bgSecondary py-md-5">
            <div class="row justify-content-around">
                <div  data-aos="fade-right"  data-aos-duration="2500" class="col-12  col-md-6 col-lg-5 bgStoria d-flex justify-content-center align-items-center transition1">
                    <p class="title fs-1 fw-semibold primary mb-lg-4">Chi siamo</p>
                </div>
                <div  data-aos="fade-left"  data-aos-duration="2500" class="title col-12 col-lg-5 col-md-6 bgPrimary chiSiamo d-flex align-items-center ">
