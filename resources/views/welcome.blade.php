<x-layout>
    <div class="pb-lg-5 bgSecondary">
        <div class="container-fluid bgHeader d-flex flex-column justify-content-center pb-lg-4 ">
    ...
    <section class="py-5 bgSecondary" id="section1">
        <div class="container-fluid bgSecondary py-md-5">
            <div class="row justify-content-around">
                ...
                <div class="title col-12 col-lg-5 col-md-6 bgPrimary chiSiamo d-flex align-items-center ">
